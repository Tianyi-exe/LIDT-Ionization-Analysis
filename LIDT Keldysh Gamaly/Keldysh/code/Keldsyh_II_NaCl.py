...
# mred = m0 is an explicitly documented temporary project input, not a
# uniquely measured NaCl electron-hole reduced mass.
# The source paper and input document use gamma = 3.30 at the reference
# condition, corresponding to E = sqrt[I/(c*n*eps0)] with no factor of two.
# This model follows that convention throughout.
NACL_INPUT: Dict[str, Any] = {
    "reference_file": "../input_parameters/NaCl_Keldysh_Parameter.docx",
    "material": {
        "name": "NaCl",
        "mat_flag": 1,
        "bandgap_ev": 8.5,
        "mred_over_me": 1.0,
        "parameter_status": (
            "Temporary project inputs from NaCl_Keldysh_Parameter.docx: "
            "mred = 1.0 m0 and Eg = 8.5 eV. The document identifies mred "
            "as temporary; replace it with band-specific "
    ...
    "cases": [
        {
            ...
            "input_note": (
                ...
                "full 1/e^2 intensity beam diameters a = 226.6 um and "
                "b = 429.7 um. Peak "
...
def save_nacl_plot_variables(
    ...
    """Save long-format NaCl plot data as CSV tables only."""
    ...
    print(f"Saved NaCl CSV data to {output_dir}")
