...
# Exact SI definitions and 2022 CODATA values, aligned with the standalone
# BaF2, NaCl, Ti:Sapphire, and GaAs scripts.
C0 = 299792458.0
...
def keldysh_full_rate_m3_s(
    ...
    if np.any(positive):
        ...
        with np.errstate(divide="ignore", invalid="ignore", over="ignore", under="ignore"):
            # Source-paper convention: E = sqrt[I/(c n0 eps0)].
...
def save_pi_ii_14_plot_variables(
    ...
    """
    Save labeled variables used by the 14 PI/II plot panels as CSV only.
    ...
    print(f"Saved PI/II CSV data to {output_dir}")
